...
const EVENT_TEMPLATES: Record<HabiticaEventType, EventTemplate> = {
  ...
  NUTRITION_HABIT: {
    type: "habit",
    text: "[Brio] Hábito Nutricional Limpio",
    notes: "Ayuno intermitente, cero ultraprocesados o meta proteica.",
    priority: 1,
    up: true,
    down: false,
    tags: ["brio", "nutrition"],
  ...
  SCHEDULED_MEAL_COMPLETED: {
    type: "habit",
    text: "[Brio] Comida Planificada / Meal Prep",
    notes: "Comer según la planificación nutricional preparada.",
    priority: 1,
    up: true,
    down: false,
    tags: ["brio", "nutrition"],
